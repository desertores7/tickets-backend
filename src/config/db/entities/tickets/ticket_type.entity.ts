...
export class TicketTypeEntity {
   ...
   * usa el default del sistema según el precio de la entrada (ver
   * `orders/services/core/max-per-buyer.ts`, configurable por Admin). Distinto
   * de `maxPerOrder`: ese solo limita una orden puntual — sin esto, alguien
   * puede juntar varias órdenes pagadas (o varias pestañas con reservas
   * pendientes en paralelo) para superarlo igual.
   */
