...
const tableName = 'user_token_session' as const;
@Entity(tableName, { database: DB_NAME.user, synchronize: false })
export class UserTokenSessionEntity {
  ...
  //Relations
  @ManyToOne(() => UserEntity, user => user.userTokenSessions)
  @JoinColumn({ name: 'userUuid', referencedColumnName: 'uuid' })
  user: UserEntity;
}

export const UserTokenSessionEntityData = {
  name: tableName,
  entity: UserTokenSessionEntity
} as const;